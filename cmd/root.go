...
dt concat -name x file1 file2 ... concatenate csv files into a single file and name it x`,
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.dt.yaml)")
